...
uint8_t                  wifi_sta_ip_stack_memory[WIFI_STA_IP_STACK_SIZE] BSP_PLACE_IN_SECTION_V2(".stack.WiFi_STA")BSP_ALIGN_VARIABLE_V2(BSP_STACK_ALIGNMENT);
NX_DHCP                  wifi_sta_dhcp_client  BSP_PLACE_IN_SECTION_V2(".stack.DHCP_wihi_STA")BSP_ALIGN_VARIABLE_V2(BSP_STACK_ALIGNMENT);
...
uint32_t WIFI_STA_init_TCP_stack(void)
{
  ...
  if ((wifi_sta_ip_ptr == NULL)  || (wifi_sta_arp_memory == NULL)) goto _err;
