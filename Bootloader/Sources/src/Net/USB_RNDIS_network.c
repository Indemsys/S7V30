...
/*-----------------------------------------------------------------------------------------------------
  ...
  \return uint8_t
-----------------------------------------------------------------------------------------------------*/
static uint8_t RNDIS_interface_active_flag(void)
{
...
//  sof_cnt_prev = sof_cnt_curr;
  ...
  if ((RNDIS_interface_active_flag() == 1) && (RNDIS_network_active_flag() == 0))
  {
    RNDIS_start_network();
  }
  if ((RNDIS_interface_active_flag() == 0) && (RNDIS_network_active_flag() == 1))
  {
    RNDIS_stop_network();
  }
}
