...
extern   "C"
{
  ...
  /* Define FTP TCP socket create options.  */
    ...
    #define NX_FTP_DATA_TOS                     NX_IP_MAX_RELIABLE //NX_IP_NORMAL
  #endif

  #ifndef NX_FTP_FRAGMENT_OPTION
    #define NX_FTP_FRAGMENT_OPTION              NX_FRAGMENT_OKAY // NX_DONT_FRAGMENT
  #endif
    ...
    #define NX_FTP_DATA_WINDOW_SIZE             (2048*8)
  #endif
    ...
    #define NX_FTP_SERVER_TIMEOUT               NX_IP_PERIODIC_RATE*10
  #endif
    ...
    #define NX_FTP_USERNAME_SIZE                32
  #endif

  #ifndef NX_FTP_PASSWORD_SIZE
    #define NX_FTP_PASSWORD_SIZE                32
  #endif
  ...
  /* Define the FTP data port retry parameters.  */
    ...
    #define NX_FTP_SERVER_RETRY_SECONDS         1           /* 2 second initial timeout                            */
  #endif

  #ifndef NX_FTP_SERVER_TRANSMIT_QUEUE_DEPTH
    #define NX_FTP_SERVER_TRANSMIT_QUEUE_DEPTH  40          /* Maximum of 20 queued transmit packets               */
  #endif

  #ifndef NX_FTP_SERVER_RETRY_MAX
    #define NX_FTP_SERVER_RETRY_MAX             20          /* Maximum of 10 retries per packet                    */
  #endif
