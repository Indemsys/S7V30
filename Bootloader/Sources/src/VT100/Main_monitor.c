...
{
  "S7V30 Auxiliary actions",
  "\033[5C MENU \r\n"
  "\033[5C <1> - Setting the date and time\r\n"
  "\033[5C <3> - Save bootloder parameters to file\r\n"
  "\033[5C <R> - Display previous menu\r\n"
  "\033[5C <M> - Display main menu\r\n",
  AUX_ACT_ITEMS,
};
...
const T_VT100_Menu      MENU_MAIN             =
{
  "S7V30 bootloader",
  "\033[5C MAIN MENU \r\n"
  "\033[5C <1> - Bootloader parameters\r\n"
  "\033[5C <2> - Auxiliary actions\r\n"
  "\033[5C <3> - Log\r\n"
  "\033[5C <4> - Reset\r\n",
  MENU_MAIN_ITEMS,
};
...
static void Do_Copy_Module_Settings_to_File(uint8_t keycode)
{
  ...
  res = Save_settings_to(&ivar_inst, MEDIA_TYPE_FILE, PARAMS_MOD_JSON_FILE_NAME, BOOTL_PARAMS);
  if (res == RES_OK)
  {
