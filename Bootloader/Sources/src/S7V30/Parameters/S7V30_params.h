...
#define  S7V30BOOT_MATLAB               7
#define  S7V30BOOT_SNTP                 8
#define  S7V30BOOT_WIFI_STA             9
#define  S7V30BOOT_WIFI_AP              10
#define  S7V30BOOT_Telnet               11
#define  S7V30BOOT_WIFI_STA_COMMON      12
#define  S7V30BOOT_WIFI_STA_CFG1        13
...
typedef struct
{
  ...
  uint8_t        en_auto_protection;            // Enable auto protection (1-yes, 0-no) | def.val.= 1
  ...
  uint8_t        wifi_sta_cfg1_en;              // Enable configuration 1  (1-yes, 0-no) | def.val.= 0
  ...
  uint8_t        wifi_sta_cfg2_en;              // Enable configuration 2  (1-yes, 0-no) | def.val.= 0
