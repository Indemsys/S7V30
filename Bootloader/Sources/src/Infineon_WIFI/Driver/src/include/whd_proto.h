...
extern "C"
{
  ...
  ******************************************************/
  struct whd_proto
  {
      ...
      whd_result_t (*set_ioctl)(whd_interface_t ifp, uint32_t command, whd_buffer_t send_buffer_hnd,whd_buffer_t *response_buffer_hnd);
      whd_result_t (*get_ioctl)(whd_interface_t ifp, uint32_t command, whd_buffer_t send_buffer_hnd,whd_buffer_t *response_buffer_hnd);
  ...
  static inline void* whd_proto_get_iovar_buffer(whd_driver_t whd_driver, whd_buffer_t *buffer, uint16_t data_length, const char *name)
  {
    return whd_driver->proto->get_iovar_buffer(whd_driver, buffer, data_length, name);
  }

  static inline whd_result_t whd_proto_set_ioctl(whd_interface_t ifp, uint32_t command, whd_buffer_t send_buffer_hnd, whd_buffer_t *response_buffer_hnd)
  {
    return ifp->whd_driver->proto->set_ioctl(ifp, command, send_buffer_hnd, response_buffer_hnd);
  }

  static inline whd_result_t whd_proto_get_ioctl(whd_interface_t ifp, uint32_t command, whd_buffer_t send_buffer_hnd, whd_buffer_t *response_buffer_hnd)
  {
    return ifp->whd_driver->proto->get_ioctl(ifp, command, send_buffer_hnd, response_buffer_hnd);
  }

  static inline whd_result_t whd_proto_set_iovar(whd_interface_t ifp, whd_buffer_t send_buffer_hnd, whd_buffer_t *response_buffer_hnd)
  {
    return ifp->whd_driver->proto->set_iovar(ifp, send_buffer_hnd, response_buffer_hnd);
  }

  static inline whd_result_t whd_proto_get_iovar(whd_interface_t ifp, whd_buffer_t send_buffer_hnd, whd_buffer_t *response_buffer_hnd)
  {
