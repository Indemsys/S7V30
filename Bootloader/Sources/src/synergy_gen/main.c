...
#define MAIN_THREAD_STACK_SIZE (1024*4)
static uint8_t main_thread_stack[MAIN_THREAD_STACK_SIZE] BSP_PLACE_IN_SECTION_V2(".stack.main_thread")BSP_ALIGN_VARIABLE_V2(BSP_STACK_ALIGNMENT);
