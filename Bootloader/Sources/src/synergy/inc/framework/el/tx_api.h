...
typedef struct TX_THREAD_STRUCT
{
    ...
    VOID                (*tx_thread_entry)(ULONG id); // @suppress("Type cannot be resolved")
    ULONG               tx_thread_entry_parameter; // @suppress("Type cannot be resolved")
    ...
    /* Define the thread's cleanup function and associated data.  This
       ...
       a timeout.  */
    VOID                (*tx_thread_suspend_cleanup)(struct TX_THREAD_STRUCT *thread_ptr, ULONG suspension_sequence); // @suppress("Type cannot be resolved")
    VOID                *tx_thread_suspend_control_block; // @suppress("Type cannot be resolved")
    struct TX_THREAD_STRUCT
