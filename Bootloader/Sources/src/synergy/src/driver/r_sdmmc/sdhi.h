...
// Здесь снимается маска маска прерываний с :
// bit 0  CMDEM   Command Error Interrupt Request Mask
// bit 1  CRCEM   CRC Error Interrupt Request Mask
// bit 2  ENDEM   End Bit Error Interrupt Request Mask
// bit 3  DTOM    Data Timeout Interrupt Request Mask
// bit 4  ILWM    SD_BUF0 Register Illegal Write Interrupt Request Mask
// bit 5  ILRM    SD_BUF0 Register Illegal Read Interrupt Request Mask
// bit 6  RSPTOM  Response Timeout Interrupt Request Mask
// bit 8  BREM    BRE Interrupt Request Mask
// bit 9  BWEM    BWE Interrupt Request Mask
