...
//
__no_init static char _acUpBuffer0[BUFFER_SIZE_UP]     ;
__no_init static char _acDownBuffer0[BUFFER_SIZE_DOWN] ;
__no_init static char _acUpBuffer1[BUFFER_SIZE_UP]     ;
__no_init static char _acDownBuffer1[BUFFER_SIZE_DOWN] ;
