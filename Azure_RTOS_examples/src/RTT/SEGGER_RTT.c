...
//
__no_init static char _acUpBuffer0[BUFFER_SIZE_UP]       @ ".sdram";
__no_init static char _acDownBuffer0[BUFFER_SIZE_DOWN]   @ ".sdram";
__no_init static char _acUpBuffer1[BUFFER_SIZE_UP]       @ ".sdram";
__no_init static char _acDownBuffer1[BUFFER_SIZE_DOWN]   @ ".sdram";
...
static SEGGER_RTT_CB _SEGGER_RTT  = {
  ...
  { { "Terminal1",&_acUpBuffer0[0],   sizeof(_acUpBuffer0),   0, 0, SEGGER_RTT_MODE_NO_BLOCK_SKIP },
    { "Terminal2",&_acUpBuffer1[0],   sizeof(_acUpBuffer1),   0, 0, SEGGER_RTT_MODE_NO_BLOCK_SKIP }},
  { { "Terminal1",&_acDownBuffer0[0], sizeof(_acDownBuffer0), 0, 0, SEGGER_RTT_MODE_NO_BLOCK_SKIP },
    { "Terminal2",&_acDownBuffer1[0], sizeof(_acDownBuffer1), 0, 0, SEGGER_RTT_MODE_NO_BLOCK_SKIP }},
};
