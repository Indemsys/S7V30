...
sdmmc_cfg_t g_sdhi1_cfg =
{
  .hw =
  {
    ...
    .bus_width     = SDMMC_BUS_WIDTH_4_BITS, //SDMMC_BUS_WIDTH_1_BIT,
    .channel       = 1,
  },
  ...
  .access_ipl      =(8),                // Приоритет прерывания возникающего после передачи команд или в случае ошибки на шине SDIO
  .sdio_ipl        =(8),                // Приоритет прерывания возникающего в момент прихода пакета прерывания от SDIO модуля
