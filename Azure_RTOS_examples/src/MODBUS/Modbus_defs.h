  ...
  #define  MODBUS_STOP_1BIT                           SCI_1_STOP_BIT
  #define  MODBUS_STOP_2BIT                           SCI_2_STOP_BIT


  #define  MODBUS_PARITY_NONE                         SCI_NO_PRITY
  #define  MODBUS_PARITY_ODD                          SCI_ODD_PRITY
  #define  MODBUS_PARITY_EVEN                         SCI_EVEN_PRITY
