...
#ifndef SF_CRYPTO_KEY_PRIVATE_API_H
#define SF_CRYPTO_KEY_PRIVATE_API_H
...
ssp_err_t   SF_CRYPTO_KEY_StatusGet (sf_crypto_key_ctrl_t * const p_api_ctrl, sf_crypto_key_state_t * p_status);
...
#endif /* SF_CRYPTO_KEY_PRIVATE_API_H */
