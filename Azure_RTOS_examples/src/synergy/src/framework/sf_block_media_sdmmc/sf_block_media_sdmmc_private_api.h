...
#ifndef SF_BLOCK_MEDIA_SDMMC_PRIVATE_API_H
#define SF_BLOCK_MEDIA_SDMMC_PRIVATE_API_H
...
ssp_err_t SF_Block_Media_SDMMC_Read (sf_block_media_ctrl_t * const p_ctrl,
		                             uint8_t * const p_dest,
									 uint32_t const start_block,
									 uint32_t const block_count);
ssp_err_t SF_Block_Media_SDMMC_Write (sf_block_media_ctrl_t * const p_ctrl,
...
#endif /* SF_BLOCK_MEDIA_SDMMC_PRIVATE_API_H */
