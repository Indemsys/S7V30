...
UINT  ux_dcd_synergy_initialize_transfer_support(ULONG dcd_io, UX_DCD_SYNERGY_TRANSFER *p_transfer_instance)
{
  ...
  if (UX_SUCCESS == status)
  {
    ...
    if (NULL != p_transfer_instance)
    {
      ...
      {
        dcd_synergy->ux_dcd_synergy_transfer.ux_synergy_transfer_tx = (transfer_instance_t *) p_transfer_instance->ux_synergy_transfer_tx;

        /** Setup the Transfer module for transmission. */
        dcd_synergy->ux_dcd_synergy_transfer_cfg_tx.p_info   = dcd_synergy->ux_dcd_synergy_transfer.ux_synergy_transfer_tx->p_cfg->p_info;
        ...
        dcd_synergy->ux_dcd_synergy_transfer_cfg_tx.p_info->repeat_area    = TRANSFER_REPEAT_AREA_SOURCE; //TRANSFER_REPEAT_AREA_DESTINATION;
        ...
        dcd_synergy->ux_dcd_synergy_transfer_cfg_tx.irq_ipl     = dcd_synergy->ux_dcd_synergy_transfer.ux_synergy_transfer_tx->p_cfg->irq_ipl;
        dcd_synergy->ux_dcd_synergy_transfer_cfg_tx.p_extend    = dcd_synergy->ux_dcd_synergy_transfer.ux_synergy_transfer_tx->p_cfg->p_extend;

        sem_create_status = _ux_utility_semaphore_create(&dcd_synergy->dma_tx_completion_semaphore, "dma_tx_completion_sem", 0);
        ...
        ssp_err = dcd_synergy->ux_dcd_synergy_transfer.ux_synergy_transfer_tx->p_api->open(dcd_synergy->ux_dcd_synergy_transfer.ux_synergy_transfer_tx->p_ctrl, &dcd_synergy->ux_dcd_synergy_transfer_cfg_tx);
      ...
      {
        dcd_synergy->ux_dcd_synergy_transfer.ux_synergy_transfer_rx = (transfer_instance_t *) p_transfer_instance->ux_synergy_transfer_rx;

        /** Setup the Transfer module for reception. */
        dcd_synergy->ux_dcd_synergy_transfer_cfg_rx.p_info   = dcd_synergy->ux_dcd_synergy_transfer.ux_synergy_transfer_rx->p_cfg->p_info;
        ...
        dcd_synergy->ux_dcd_synergy_transfer_cfg_rx.p_info->repeat_area    = TRANSFER_REPEAT_AREA_DESTINATION; // TRANSFER_REPEAT_AREA_SOURCE;
        ...
        dcd_synergy->ux_dcd_synergy_transfer_cfg_rx.irq_ipl      = dcd_synergy->ux_dcd_synergy_transfer.ux_synergy_transfer_rx->p_cfg->irq_ipl;
        dcd_synergy->ux_dcd_synergy_transfer_cfg_rx.p_extend     = dcd_synergy->ux_dcd_synergy_transfer.ux_synergy_transfer_rx->p_cfg->p_extend;
        /* Wait till IRQ end */
        dcd_synergy->ux_dcd_synergy_transfer_cfg_rx.p_info->irq = TRANSFER_IRQ_END;

        sem_create_status = _ux_utility_semaphore_create(&dcd_synergy->dma_rx_completion_semaphore, "dma_rx_completion_sem", 0);
        if (TX_SUCCESS != sem_create_status)
        {
          return (UINT)UX_SEMAPHORE_ERROR;
        }
        ...
        ssp_err = dcd_synergy->ux_dcd_synergy_transfer.ux_synergy_transfer_rx->p_api->open(dcd_synergy->ux_dcd_synergy_transfer.ux_synergy_transfer_rx->p_ctrl, &dcd_synergy->ux_dcd_synergy_transfer_cfg_rx);
        if (ssp_err != SSP_SUCCESS)
        {
          status = (UINT)UX_CONTROLLER_INIT_FAILED;
        }
...
static void ux_dcd_dma_complete_rx(transfer_callback_args_t *p_args)
{
  ...
  ux_dcd_synergy_register_clear(dcd_synergy,UX_SYNERGY_DCD_PIPE1CTR  +((dcd_synergy->read_pipe_number - 1UL) * 2UL),UX_SYNERGY_DCD_PIPECTR_PID_MASK);
