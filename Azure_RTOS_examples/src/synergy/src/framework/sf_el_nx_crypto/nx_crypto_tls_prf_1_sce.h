...
/*                                                                        */
/*    nx_crypto_tls_prf_1_sce.h                           PORTABLE C      */
/*                                                           5.11         */
/*  AUTHOR                                                                */
/*                                                                        */
...
typedef struct NX_SECURE_TLS_PRF_1_SCE_STRUCT {
    /* Buffer to hold PRF seed and label for concatenation. */
    UCHAR nx_secure_tls_prf_seed_label_buf[100];

    /* Buffer to store intermediate MD5 output. */
    UCHAR nx_secure_tls_prf_md5_buf[200];
    
    /* Buffer to store intermediate SHA-1 output. */
    UCHAR nx_secure_tls_prf_sha1_buf[200];

    /* Pointer to secret data and its length. */
    UCHAR *nx_secure_tls_prf_secret;
    USHORT nx_secure_tls_prf_secret_length;

    /* Metadata for P-HASH routines. */
    NX_SECURE_TLS_PHASH_SCE nx_secure_tls_phash_md5;
    NX_SECURE_TLS_PHASH_SCE nx_secure_tls_phash_sha_1;

} NX_SECURE_TLS_PRF_1_SCE;


UINT _nx_crypto_tls_prf_1_sce(NX_SECURE_TLS_PRF_1_SCE *prf, UCHAR *secret, UINT secret_len, UCHAR *label, UINT label_len,
