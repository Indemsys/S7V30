...
/*LDRA_INSPECTED 219 s - This is an allowed exception to LDRA standard 219 S "User name starts with underscore."*/
/*LDRA_INSPECTED 57 D - This global is being initialized at it's declaration below. */
//BSP_DONT_REMOVE static uint8_t g_process_stack[BSP_CFG_STACK_PROCESS_BYTES] BSP_PLACE_IN_SECTION_V2(BSP_SECTION_STACK) BSP_ALIGN_VARIABLE_V2(BSP_STACK_ALIGNMENT);
#endif
...
/*LDRA_INSPECTED 219 s - This is an allowed exception to LDRA standard 219 S "User name starts with underscore."*/
/*LDRA_INSPECTED 57 D - This global is being initialized at it's declaration below. */
//BSP_DONT_REMOVE static uint8_t g_heap[BSP_CFG_HEAP_BYTES] BSP_ALIGN_VARIABLE_V2(BSP_STACK_ALIGNMENT) BSP_PLACE_IN_SECTION_V2(BSP_SECTION_HEAP);
#endif
