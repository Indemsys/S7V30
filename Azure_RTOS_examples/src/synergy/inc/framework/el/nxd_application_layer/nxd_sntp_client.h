...
/* Define the SNTP client structure.  */
    ...
    typedef struct NX_SNTP_CLIENT_STRUCT
    {
        ...
        ULONG                           nx_sntp_client_unicast_poll_interval_const;
...
UINT    nx_sntp_client_initialize_unicast(NX_SNTP_CLIENT *client_ptr, ULONG unicast_time_server, ULONG poll_interval);
...
UINT    _nxd_sntp_client_initialize_unicast(NX_SNTP_CLIENT *client_ptr, NXD_ADDRESS *unicast_time_server, ULONG poll_interval);
