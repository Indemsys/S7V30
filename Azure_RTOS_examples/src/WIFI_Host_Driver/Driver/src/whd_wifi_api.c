                                          ...
                                          uint8_t key_length, cy_semaphore_t *semaphore)
{
    ...
    {
        CHECK_RETURN(cy_rtos_init_semaphore(&whd_driver->internal_info.active_join_mutex,"WHD_driver_join_mutex", 1, 0) );
                                ...
                                uint8_t key_length)
{
    ...
    CHECK_RETURN(cy_rtos_init_semaphore(&join_semaphore,"WHD_join_semaphore", 1, 0) );
                       ...
                       const uint8_t *security_key, uint8_t key_length)
{
    ...
    CHECK_RETURN(cy_rtos_init_semaphore(&join_sema,"WHD_join_sema", 1, 0) );
                             ...
                             )
{
    ...
    DISABLE_COMPILER_WARNING(diag_suppress = Pa039)
    CHECK_RETURN(cy_rtos_init_semaphore(&scan_userdata.scan_semaphore, "WHD_scan_semaphore", 1, 0) );
    ENABLE_COMPILER_WARNING(diag_suppress = Pa039)
